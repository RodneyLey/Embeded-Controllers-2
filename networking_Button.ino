    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          if (buttonPress == 1) {
            client.println("<cke:html><cke:body bgcolor=#FFFFFF>MY NAME IS RODNEY MWALE</cke:body></cke:html>");
          }
          else if (buttonPress == 0){
            client.println("<cke:html><cke:body bgcolor=#000000 text=#FFFFFF>THIS IS EMBEDDED CONTROLLERS 2</cke:body></cke:html>");
          }
